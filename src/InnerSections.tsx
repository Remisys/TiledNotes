...
import { SectionEnum, SectionModel } from "./Main";

export const InnerSections: FC<{
  fileName: string;
  ...
  return (
    <div className="m-10 flex flex-col items-center w-[100%] overflow-y-auto ">
      <div className="pt-[100px] md:pt-[125px] xl:pt-[150px]   pb-[0px] w-full flex flex-col  justify-center ">
