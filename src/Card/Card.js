...
function Card(props){
    ...
    return(
        ...
        <div>          
            <textarea className=" text-black font-bold h-[1.5em] text-[20px] w-[100%] mb-2 mx-1 text-center bg-transparent"   disabled={!onHover} spellCheck="false" >Heading</textarea>
            <hr className="border-t-2 border-t-sky-700 my-1 shadow-xl"></hr>
            <textarea className="text-black w-[100%] grow mx-1"  disabled={!onHover} spellCheck="false bg-transparent" >Content</textarea>
        </div>
        </div>
